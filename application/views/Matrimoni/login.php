                 ...
                 <div class="header-inner">
					  <h1 class="logo">
						...
						<div class="header-right-w3ls">
							<a href="<?php echo base_url('index.php/Matrimoni_controller/login')?>">Log In</a>
							<a href="<?php echo base_url('index.php/Matrimoni_controller/register')?>">Register</a>
						</div>
						<div class="clearfix"></div>
				</div>
</div>			
...
<div class="login elite-app">
	...
	<div class="col-md-8 login-form-w3-agile" style="height: 490px;width: 1100px">
		<br><br>
			<form action="<?php echo base_url('index.php/Matrimoni_controller/signin')?>" method="post">
