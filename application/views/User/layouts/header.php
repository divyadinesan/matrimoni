                 ...
                 <div class="header-inner">
					  <h1 class="logo">
						...
						<div class="header-right-w3ls">
							<a href="<?php echo base_url('index.php/User_controller/user_home')?>">Home</a>
							<a href="<?php echo base_url('index.php/User_controller/myprofile')?>">My Profile</a>
							<a href="<?php echo base_url('index.php/User_controller/mymatches')?>">My Matches</a>
							<a href="<?php echo base_url('index.php/User_controller/my_request')?>">My Request</a>
							<a href="<?php echo base_url('index.php/User_controller/request')?>">Received Request</a>
							<!-- <a href="<?php echo base_url('index.php/User_controller/match_found')?>">Match Found</a> -->
